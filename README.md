...
The platform is designed to simplify the mentor-mentee relationship by making it easy for students to connect, apply, and manage their profiles. Admins can ensure the platform runs smoothly by overseeing the interactions and managing user data.
...
### Demo Video
[Watch the demo video showcasing the project here](https://www.youtube.com/watch?v=hFcsrr2PXi8)

### Test Users
Here are the credentials for different user roles:
